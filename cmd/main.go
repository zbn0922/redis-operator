...
import (
	...
	"github.com/zbn0922/redis-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(zbn0922v1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cda43ae6.github.com",
	...
	if err != nil {
		setupLog.Error(err, "Failed to NewForConfig", "controller", "Redis")
		os.Exit(1)
	}
	if err := (&controller.RedisReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "Redis")
		os.Exit(1)
	}
